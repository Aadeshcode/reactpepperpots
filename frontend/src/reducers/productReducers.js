...
export const productDetailsReducer = (state = {
  availablePots: {}, availablePotsIds: [] , reviews:[]
}, action) => {
  switch (action.type) {
...
export const productDeleteReducer = (state = { deleted: "" }, action) => {
  switch (action.type) {
...
export const productSuggestionReducer = (state = { products: [] }, action) => {
  switch (action.type) {
